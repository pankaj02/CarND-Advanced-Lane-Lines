...
def sliding_window_pipeline(img):
    binary_warped = warp_binary_pipeline(img)
    ...
    if first_image == True:
        ...
        visualize2(binary_warped, left_fitx, left_lane_inds, ploty, right_fitx,
                   right_lane_inds)
        print("Done")


def visualize2(binary_warped, left_fitx, left_lane_inds, ploty, right_fitx,
               right_lane_inds):
    nonzero = binary_warped.nonzero()
    nonzeroy = np.array(nonzero[0])
    nonzerox = np.array(nonzero[1])
...
if __name__ == '__main__':
    ...
    images = ['test_images/straight_lines1', 'test_images/straight_lines2', 'test_images/test1.jpg']

    images = glob.glob('test_images/*.jpg')

    for image in images:
        image = plt.imread(image)
        sliding_window_pipeline(image)
